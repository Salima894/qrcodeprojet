...
<meta http-equiv="content-type" content="text/html; charset=UTF-8"/>
	<meta name="description" content="CAS SPECIAUX Casablanca Maroc, Verrières Casablanca Maroc ENFANTS Casablanca Maroc Cloison Amovible En Aluminium Casablanca Maroc." />
	<meta name="keywords" content="CAS SPECIAUX Casablanca Maroc, Verrières Casablanca Maroc ENFANTS Casablanca Maroc Cloison Amovible En Aluminium Casablanca Maroc." />
    <meta name="author" content="Info_SZM">

	<title>CAS SPECIAUX</title>
    ...
    <div class="side-panel-widget mt-30">
      <div class="widget no-border">
          ...
          <li class="font-14 mb-5"> <i class="fa fa-phone text-theme-colored"></i> <a href="+212 5 22 98 14 68" class="text-gray">Fax : +212 5 22 98 14 68</a> </li>
		            <li class="font-14 mb-5"> <i class="fa fa-phone text-theme-colored"></i> <a href="+212 6 61 34 34 04" class="text-gray">Téléphone : +212 6 61 34 34 0</a> </li>
...
<div id="wrapper">
          ...
          <div class="col-md-9">
            <div class="widget no-border m-0">
              <ul class="list-inline pull-right flip sm-pull-none sm-text-center mt-5">
                <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-white"></i> <a class="text-white" href="+212 (0)5 22 98 14 68">Fax : +212 (0)5 22 98 14 68</a> </li>
				                <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-white"></i> <a class="text-white" href="+212 (0)6 61 34 34 04">Téléphone : +212 (0)6 19 18 10 68</a> </li>
                <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-white"></i> <a class="text-white" href="Info@SZM.com"> Info@SZM.com </a> </li>
  ...
  <div class="main-content">
    <section class="inner-header divider layer-overlay overlay-deep" data-bg-img="images/moustiquaire.jpg">
      <div class="container pt-90 pb-50">
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-12 xs-text-center">
              <h2 class="font-28">CAS SPECIAUX</h2>
              <ol class="breadcrumb white mt-10">
                <li><a href="index.php">Accueil</a></li>
                <li class="active text-theme-colored">CAS SPECIAUX</li>
              </ol>
            </div>
          </div>
        </div>
...
<section class="bg-light">
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h4 class="text-theme-colored title-border">CAS SPECIAUX</h4>
            </div>
          </div>
          <div class="row">
					<div class="col-md-7">
<p style="font-size:16px">
Mettez fin à votre souffrance due aux insectes nuisibles qui vous ôtent l’envie de dormir, grâce aux CAS SPECIAUXSZM qui tout en vous donnant une solution de confort, gardent l’aspect esthétique de votre domicile.
</p>
					</div>
...
<?php 
  ...
  if(isset($_POST['create']))
  {
	...
	//qrname qrprenom qrsex qrdate qradresse qrtel qremail qrmdp qrcmdp qrmal qrges
	...
	//form_name form_prenom  form_sex form_date  form_adresse form_tel form_email form_mal form_ges    form_mdp form_cmdp
	
    $qrmal = $_POST['form_mal'];
    $qrges = $_POST['form_ges'];
   
    
    $qrImgName = $qrname.$qrprenom.rand();
    ...
    $final = "Mon Prénom est : " . $qrprenom ."\n".
             ...
             "Sa Maladies est  : ". $qrmal ."\n".
			 "Gestion de situation critique  : ". $qrges ."\n".
             $dev;
	//qrname qrprenom qrsex qrdate qradresse qrtel qremail qrmdp qrcmdp qrmal qrges
	...
	$inscasp = $meravi->insertcasspeciaux($qrmal ,$qrges);
       
	   if($insQr==true  &&  $insuser==true  &&    $inscasp ==true )
    {
          echo "<script>alert('Thank You $qrmal. Success Create Your QR Code'); window.location='CAS SPECIAUX.php?success=$qrimage';</script>";
    }
    else
    {
...
<div class="text-center">
    <img src="userQr/<?php echo $_GET['success']; ?>" alt="">
          ...
          <div class="form-group">
              <a href="CAS SPECIAUX.php" class="btn btn-dark btn-theme-colored btn-flat mr-5">Go back To generate again</a>
          </div>
        </div>
  <?php
  }
  ...
  ?>
		   ...
		   <!-- first-form begin  -->
			  ...
			  <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="form_mal">Maladies  <small>*</small></label>
                    <input id="form_mal" name="form_mal" class="form-control" type="text" placeholder="Entrer le Nom de la maladie " required="">
                  </div>
                </div>                  
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="form_ges">Gestion de situation critique  <small>*</small></label>
                    <input id="form_ges" name="form_ges" class="form-control " type="text" placeholder="">
                  </div>  
                </div>
              </div>
              <div class="row">
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-dark btn-theme-colored btn-flat mr-5"  name="create">Submit</button>
              </div>
            </form>
...
?>
	...
	<section class="divider layer-overlay overlay-dark-7 mt-30" data-bg-img="images/moustiquaire.jpg">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <ul class="list list-border">
              <li><a href="+212 (0)6 61 34 34 04">Téléphone : +212 (0)6 19 18 10 68</a></li>
		    <li><a href="+212 (0)5 22 98 14 68">Fax : +212 (0)5 22 98 14 68</a></li>
              <li><a href="Info@SZM.com">Info@SZM.com</a></li>
