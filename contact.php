...
<div id="wrapper">
  ...
  <div class="main-content">
    <section class="inner-header divider layer-overlay overlay-deep" data-bg-img="images/inner-banner.jpg" style="background-image: url(&quot;images/inner-banner.jpg&quot;);">
...
?> <!-----    form_name form_email   form_subject  form_phone--->

    <section class="divider layer-overlay overlay-deep" data-bg-img="images/bg/bg1.jpg">
      <div class="container">
        <div class="row pt-30">
          <div class="col-md-7">
            <h3 class="line-bottom mt-0 mb-30">Êtes-vous interessé?</h3>
            <form id="contact_form" name="contact_form" class="form-transparent" action="mail.php" method="POST">
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input id="form_name" name="form_name" class="form-control" type="text" placeholder="Entrer Nom" required="">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="form_email">Email <small>*</small></label>
                    <input id="form_email" name="form_email" class="form-control required email" type="email" placeholder="Entrer Email">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input id="form_subject" name="form_subject" class="form-control required" type="text" placeholder="Entrer Sujet">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="form_phone">Téléphone</label>
                    <input id="form_phone" name="form_phone" class="form-control" type="text" placeholder="Entrer Téléphone">
                  </div>
                </div>
              </div>          
              <div class="form-group">
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-dark btn-theme-colored btn-flat mr-5"  name="submit">Envoyer votre message</button>
              </div>
            </form>
