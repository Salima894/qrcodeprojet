...
<div id="wrapper">
        ...
        <div class="container">
          <nav id="menuzord-right" class="menuzord blue bg-lightest">
            ...
            <ul class="menuzord-menu">
              <li><a href="index.php">Accueil</a></li>
			<li class="active"><a href="qui-sommes-nous.php">QUI SOMMES NOUS?</a></li>
  ...
  <div class="main-content">
    <section class="inner-header divider layer-overlay overlay-deep" data-bg-img="images/inner-banner.jpg">
      <div class="container pt-90 pb-50">
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-12 xs-text-center">
              <h2 class="font-28">QUI SOMMES NOUS?</h2>
              <ol class="breadcrumb white mt-10">
                <li><a href="index.php">Accueil</a></li>
                <li class="active text-theme-colored">QUI SOMMES NOUS?</li>
              </ol>
            </div>
          </div>
        </div>
...
<section class="bg-light">
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h4 class="text-theme-colored title-border">Présentation deSZM</h4>
            </div>
          </div>
          <div class="row">
          
<p style="font-size:16px"><strong>La SociétéSZM</strong>, 
...
->afficher un texte ou rédiger un texte libre (sa version la plus grande permet d'inclure un texte d'environ 500 mots);
   ...
   <div class="col-md-12">
            ...
            <div class="gallery-isotope grid-2 gutter-small clearfix" data-lightbox="gallery" style="position: relative; height: 1284px;">
              <div class="gallery-item" style="position: absolute; left: 0px; top: 0px;">
                <a href="images/Slide4.jpg" data-lightbox="gallery-item" title="Title Here 1"><img src="images/Slide4.jpg" alt=""></a>
              </div>
      
              <div class="gallery-item" style="position: absolute; left: 570px; top: 0px;">
                <a href="images/Slide5.jpg" data-lightbox="gallery-item" title="Title Here 2"><img src="images/Slide5.jpg" alt=""></a>
              </div>
              <div class="gallery-item" style="position: absolute; left: 0px; top: 428px;">
                <a href="images/Slide6.jpg" data-lightbox="gallery-item" title="Title Here 3"><img src="images/Slide6.jpg" alt=""></a>
              </div>
                     <div class="gallery-item" style="position: absolute; left: 570px; top: 428px;">
                <a href="images/Slide7.jpg" data-lightbox="gallery-item" title="Title Here 4"><img src="images/Slide7.jpg" alt=""></a>
              </div>
            </div>
          </div>
                </div>
	...
	<section class="divider layer-overlay overlay-dark-7 mt-30" data-bg-img="images/call-to-action-bg.jpg">
