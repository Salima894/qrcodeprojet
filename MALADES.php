        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-12 xs-text-center">
              <h2 class="font-28">MALADES</h2>
              <ol class="breadcrumb white mt-10">
                <li><a href="index.php">Accueil</a></li>
                <li class="active text-theme-colored">MALADES</li>
              </ol>
            </div>
          </div>
        </div>
...
<section class="bg-light">
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h4 class="text-theme-colored title-border">MALADES</h4>
            </div>
          </div>
          <div class="row">
					<div class="col-md-7">
...
catch(Exception $e)
{
        die('Erreur : '.$e->getMessage());
			...
			//table enfants
			//etape2: preparer la requete sql
            $st2=$cnx->prepare("insert into malade values (:malade,:test,:traitement,:medecin,:infe,:mdp,:cmdp)");
            //etape3: executer notre requete
            $donnesaisie2=array(
                "malade"=>$_POST["form_malade"],
                "test"=>$_POST["form_test"],
                "traitement"=>$_POST["form_traitement"],
                "medecin"=>$_POST["form_medecin"],
				"infe"=>$_POST["form_inf"],
                "mdp"=>$_POST["form_mdp"],
                "cmdp"=>$_POST["form_cmdp"]
            );
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input id="form_malade" name="form_malade" class="form-control" type="text" placeholder="Entrer le Nom de la maladie " required="">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="form_test">Analyse et test <small>*</small></label>
                    <input id="form_test" name="form_test" class="form-control required email" type="email" placeholder="Entrer le nom des analyses">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input id="form_traitement" name="form_traitement" class="form-control required" type="text" placeholder="Entrer le traitement">
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input id="form_medecin" name="form_medecin" class="form-control" type="text" placeholder="Entrer le nom du medecin">
                  </div>
                </div>
              </div>
               <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <input id="form_inf" name="form_inf" class="form-control required" type="text" placeholder="Entrer le nom de l''infirmiere">
                  </div>
                </div>
              </div>
		    <div class="row">
